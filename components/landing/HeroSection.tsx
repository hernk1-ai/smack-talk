    ...
    <section id="about" className="relative overflow-hidden border-b border-white/10">
      <div className="landing-shell grid min-h-[calc(100dvh-4.5rem)] items-start gap-6 py-6 sm:py-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(22rem,0.7fr)] lg:gap-14 lg:pb-14 lg:pt-10">
        <div className="hero-copy relative mx-auto w-full max-w-4xl text-center lg:mx-0 lg:text-left">
          <p className="text-[10px] font-black uppercase tracking-[0.24em] text-lime-300 sm:text-xs">Sports reputation platform</p>
          ...
          <h1 className="hero-title sports-display mt-4 text-[clamp(2.6rem,12vw,6.8rem)] leading-[0.86] tracking-[0.01em] text-white sm:text-[7rem] lg:text-[6.8rem] xl:text-[8rem]">
            <span className="block">LOCK TAKES.</span>
            <span className="hero-receipts block bg-gradient-to-r from-lime-300 via-white to-purple-500 bg-clip-text text-transparent drop-shadow-[0_0_24px_rgba(132,204,22,0.18)]">SHOW RECEIPTS.</span>
          </h1>
          ...
          <div className="mt-7 flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <Link href="/receipts" className="text-sm font-semibold text-gray-300 transition hover:text-lime-300">
              See Receipts
            </Link>
          </div>
        </div>

        <div className="mx-auto h-[40rem] w-full max-w-[20.5rem] overflow-hidden pb-0 sm:h-[42rem] sm:max-w-[20rem] lg:hidden">
